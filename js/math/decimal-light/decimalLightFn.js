...
function getBase10Exponent(x) {
  let e = x.e * _decimalLightConfig.LOG_BASE,
    w = x.d[0];
...
const getRoundDecimal = (decimalValue, precision) => (0, _decimalLightConfig.getExternal)() ? round(decimalValue, precision) : decimalValue;
