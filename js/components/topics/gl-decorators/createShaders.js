...
var _createShaders = exports._createShaders = function _createShaders(target) {
    var gl = target.gl,
        _target$props = target.props,
        props = _target$props === undefined ? {} : _target$props,
        _props$vertexShaderCo = props.vertexShaderCode,
        vertexShaderCode = _props$vertexShaderCo === undefined ? _defaultVertex : _props$vertexShaderCo,
        _props$fragmentShader = props.fragmentShaderCode,
        fragmentShaderCode = _props$fragmentShader === undefined ? _defaultFragment : _props$fragmentShader,
